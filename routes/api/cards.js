...
router.patch("/archive/:archive/:id", [auth, member], CardController.archiveCard);
...
router.put("/addMember/:add/:cardId/:userId", [auth, member], CardController.addOrRemoveMember);
